                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            @csrf
{{--                            <label>Company</label>--}}
{{--                            <input id="radio_company" type="radio" name="user_type" checked value="company"/>--}}

{{--                            <label>Applicant</label>--}}
{{--                            <input id="radio_applicant" type="radio" name="user_type" value="applicant"/>--}}
                            ...
                            <div id="business_name_container" class="form-group row">
